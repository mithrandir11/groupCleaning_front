    ...
    <div class=" flex flex-wrap items-center  mx-auto py-0 ">
      ...
      <div class="hidden w-full md:block md:w-auto " id="navbar-multi-level">
        ...
        <ul class="flex  items-center rounded-lg  md:space-x-8 rtl:space-x-reverse  py-3 ">
          ...
          <li>
              <NuxtLink :to="{name: 'hire'}" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">استخدام نیرو</NuxtLink>
          </li>
