        ...
        <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  ">
          ...
          <li class="group">
            <button
              ...
              class="flex items-center justify-between w-full py-2 px-3 text-gray-900  hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto "
            >
              خدمات
              <svg
            ...
            <div
              id="dropdownNavbar"
              class="z-10 hidden group-hover:block absolute font-normal  bg-white divide-y  rounded-lg shadow w-44  "
            >
              <ul
              ...
              >
                ...
                <li class="group/sub" aria-labelledby="dropdownNavbarLink">
                  <button
                  ...
                  <div
                    id="doubleDropdown"
                    class="group-hover/sub:block z-10 hidden absolute right-44 -mt-10   divide-y rounded-lg shadow w-44 "
                  >
                    <ul
                      class="py-2 text-sm text-gray-700 "
