...
<template>
    ...
    <div class="lg:w-72 mb-8 p-4 border bg-gray-50 border-gray-300 rounded-lg w-full lg:hidden inline-flex flex-col justify-start items-start gap-6  self-start">
        <div @click="showSidebar = !showSidebar" class="w-full justify-between items-center gap-2.5 inline-flex ">
            ...
            <div class="w-6 h-6 relative ">
                <svg  width="12" height="12"  aria-hidden="true"  xmlns="http://www.w3.org/2000/svg"  fill="none"  viewBox="0 0 10 6">
        ...
        <div v-if="showSidebar" class="w-full ">
            ...
            <ul class="flex-col gap-y-4 flex list-none">
                ...
                <li>
                    <div class="flex-col gap-1 flex">
                        <NuxtLink :to="{name: 'profile.notifications'}" activeClass="bg-gray-200" class="flex-col flex  rounded-lg p-3">
                            <div class="h-5 gap-3 flex">
                                <div class="relative">
    ...
    <div class="w-72 mb-8 p-4 border bg-gray-50 border-gray-300 rounded-lg hidden lg:inline-flex flex-col justify-start items-start gap-6  self-start">
